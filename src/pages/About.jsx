...
import award1 from "../assets/images2/art17.jpg";
import award2 from "../assets/images2/art15.jpg";
import award3 from "../assets/images2/art14.jpg";
      ...
      <div className="mt-16 flex justify-center">
        <div className="bg-white text-gray-800 shadow-lg rounded-xl overflow-hidden max-w-5xl flex flex-col md:flex-row items-center">
          <div className="p-8 flex-1">
            ...
            <p>-INDUMATHY MOORTHI -ceo, incubenation</p>
          </div>
          <img
            src={ceo}
