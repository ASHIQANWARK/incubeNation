...
const offeringsData = [
  { 
    ...
    icon: <FaUsers className="text-5xl text-[#ffffff]" /> 
  },
  { 
    ...
    icon: <FaLightbulb className="text-5xl text-[#ffffff]" /> 
  },
  { 
    title: "Business Support Services", 
    description: "Legal, accounting, and marketing support for startups and entrepreneurs.", 
    icon: <FaCogs className="text-5xl text-[#ffffff]" /> 
  },
  { 
      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 mt-12">
          {offeringsData.map((offering, index) => (
            <div 
              key={index} 
              className="flex flex-col items-center text-center backdrop-blur-lg bg-white/10 border border-white/20 rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:scale-105 p-6 group relative overflow-hidden"
            >
